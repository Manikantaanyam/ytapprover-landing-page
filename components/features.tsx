  ...
  return (
    <div className="mt-14 flex flex-col items-center">
      <div className="flex flex-col items-center">
        <p className="text-xl max-w-2xl text-center  font-thin ">
          Why YTApprover is the Best Platform for Content Collaboration
        </p>
        <p className="text-sm max-w-3xl  px-6 md:text-base text-black/70 dark:text-white/50 font-thin mt-4 text-center">
      ...
      <div>
        <p></p>
        <div className="px-10 grid grid-cols-1 space-y-3 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-10">
